namespace DataAccessCore.Catalog.API.Context.OtherContext
{
    ...
    public class CatalogContextSeed
    {
        public static void SeedData(IMongoCollection<Product> mongoCollection)
        {
            ...
            if (!existProduct)
            {
                mongoCollection.InsertManyAsync(GetPersonfiguredProducts());
            }
        }

        private static IEnumerable<Product> GetPersonfiguredProducts()
        {
